<template>
    <li class="lecture-content bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl relative group flex flex-col">
        <div class="relative p-5 flex-grow">
            <router-link :to="detailUrl || '#'" class="block">
                ...
                <h2 class="text-xl font-semibold text-[var(--dream-text)] mb-2 truncate group-hover:text-[var(--dream-main)]" :data-id="lecture.id">
                    {{ lecture.title }}
                </h2>
